...
interface InlineProjectComposerProps {
	parentProjectId: number
}

export default function InlineProjectComposer({parentProjectId}: InlineProjectComposerProps) {
	...
	const open = projectComposerOpen && projectComposerParentId === parentProjectId
	...
	return (
		<form className="subtask-composer subproject-composer" data-form="project" data-parent-project-id={parentProjectId} onSubmit={handleSubmit}>
			<div className="subtask-context">Add sub-project</div>
